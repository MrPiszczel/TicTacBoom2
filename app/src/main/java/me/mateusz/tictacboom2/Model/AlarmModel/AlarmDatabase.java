...
public abstract class AlarmDatabase extends RoomDatabase {
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            alarmDao.insert(new Alarm("title 1", "description 1", 5,5,5));
            alarmDao.insert(new Alarm("title 2", "description 2", 5,5,5));
            alarmDao.insert(new Alarm("title 3", "description 3", 5,5,5));
            return null;
        }
    }
}
